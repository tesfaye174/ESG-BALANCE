...
// Leggo direttamente le viste - sono gia' create nel database
...
<!-- Tre card con i numeri principali: aziende, revisori e azienda piu' affidabile -->
<div class="row g-4 mb-4">
    <div class="col-md-4">
        <div class="statistiche-card card text-center">
            <div class="card-body py-4">
                <span class="statistiche-icon"><i class="bi bi-building"></i></span>
                <h1 class="display-4 fw-bold" style="color:#0d6efd;"><?php echo $num_aziende['totale_aziende'] ?? 0; ?>
                </h1>
                <p class="mb-0" style="color:#222;">Aziende Registrate</p>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="statistiche-card card text-center">
            <div class="card-body py-4">
                ...
                <h1 class="display-4 fw-bold" style="color:#0d6efd;">
                    <?php echo $num_revisori['totale_revisori'] ?? 0; ?></h1>
                <p class="mb-0" style="color:#222;">Revisori ESG</p>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="statistiche-card card text-center">
            <div class="card-body py-4">
                ...
                <?php if (!empty($affidabilita)): ?>
                    <h1 class="display-4 fw-bold" style="color:#0d6efd;">
                        <?php echo htmlspecialchars($affidabilita[0]['nome']); ?></h1>
                    <p class="mb-0" style="color:#222;">Azienda più affidabile
                        (<?php echo $affidabilita[0]['percentuale_affidabilita']; ?>%)</p>
                <?php else: ?>
                    <h1 class="display-4 fw-bold">—</h1>
                    <p class="mb-0" style="color:#222;">Nessun dato disponibile</p>
                <?php endif; ?>
            </div>
        </div>
    </div>
...
<div class="row g-4">
    <!-- V3: Classifica affidabilita' aziende (basata sulla percentuale di bilanci approvati puri) -->
    <div class="col-md-6">
                        ...
                        <tbody>
                            ...
                            foreach ($affidabilita as $a): ?>
                                <tr>
                                    <td>
                                        <?php if ($pos === 1): ?>
                                            <i class="bi bi-trophy-fill" style="color:#0d6efd;"></i>
                                        <?php else: ?>
                                            <?php echo $pos; ?>
                                        <?php endif; ?>
                                    </td>
    ...
    <!-- V4: Classifica bilanci per numero di indicatori ESG collegati -->
    <div class="col-md-6">
        <div class="statistiche-card card h-100">
            <div class="card-header">
